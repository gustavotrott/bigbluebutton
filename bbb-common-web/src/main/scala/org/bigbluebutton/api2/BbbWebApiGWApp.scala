...
/*****
  ...
  def registerUserSessionToken(meetingId: String, intUserId: String, sessionToken: String): Unit = {
    val regUserSessionToken = new RegisterUserSessionToken(meetingId, intUserId, sessionToken)
